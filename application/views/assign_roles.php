...
<i class="fa fa-circle"></i> Online
                                ...
                                <div class="main-box">
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form class="form-horizontal" role="form">
                                            <?php $x = 1; foreach ($h->result() as $row)
                                            {  ?>
                                                <div class="checkbox-nice">
                                                    <input type="checkbox" id="checkbox-<?php echo $x; ?>" name="Roles" value="<?php echo $row->RoleId; ?>">
                                                    <label for="checkbox-<?php echo $x; ?>">
                                                        <?php echo $row->RoleId; ?>
                                                    </label>
                                                </div>
                                                <?php $x++; } ?>
                                            <div class="form-group">
                                                <div class="col-lg-10">
                                                    <input type="button" name="AssignRoles" id="AssignRoles" value="Submit" class="btn btn-success" style="margin-top: 15px;">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#AssignRoles').click(function(e) {

                var role = $("input:checked");
                var roles = "";

                console.log($("input:checked").length);

                if($("input:checked").length == 0){
                    $("#Error").show().text("Select atleast one Role");
                    return false;
                }
                ...
                $.ajax({
                    url : "<?php echo base_url(); ?>index.php/welcome/submitAssignRoles",
                    type : "POST",
                    dataType : "json",
                    data : {"Roles" : roles},
                    success : function(data) {
                        if(data == "Successful"){
                            $("#RoleMsg").show().html("Assigned successfully");
                        }
                    },
                    error : function(data) {
                        console.log(data);
