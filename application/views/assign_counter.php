...
<ol class="breadcrumb">
<li><a href="#">Home</a></li>
<li class="active"><span>Add Branch Management</span></li>
</ol>
<h1>Add Branch Management</h1>
</div>
</div>
<div class="row">
<div class="col-lg-12">
...
<div class="form-group">
<label for="BranchName" class="col-lg-2 control-label">Counter Name</label>
<div class="col-lg-10">
<input type="text" class="form-control" id="CounterName" name="CounterName" placeholder="Counter Name">
</div>
</div>
<div class="form-group">
<label for="BranchAdd" class="col-lg-2 control-label">Sort Order</label>
<div class="col-lg-10">
...
<input type="button" value="Add" id="SubmitCounter" class="btn btn-success">
</div>
</div>
</form>
</div>
