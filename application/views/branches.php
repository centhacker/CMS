                        ...
                        <div class="main-box clearfix">
                            ...
                            <header class="main-box-header clearfix">
                                <div class="filter-block pull-right">
                                    <a href="<?php echo base_url(); ?>index.php/welcome/bne" class="btn btn-primary pull-right">
                                        Add Branch
                                    </a>
                                </div>
                            </header>
                                ...
                                <div class="table-responsive clearfix">
                                    <table class="table table-hover">
                                        ...
                                        foreach ($h->result() as $row)
                                        {
                                            ...
                                            <td><a href="<?php echo base_url(); ?>index.php/welcome/editBranch/<?php echo $row->BranchId; ?>">Edit</a></td>
                                            <td><a href="<?php echo base_url(); ?>index.php/welcome/assignCounter/<?php echo $row->BranchId; ?>">Assign Counter</a></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        if (sessionStorage.getItem("CounterMsg") !== null) {
            $("#CounterMsg").show().html(sessionStorage.getItem("CounterMsg"));
            sessionStorage.removeItem("CounterMsg");
        }
    });
