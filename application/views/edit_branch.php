                                    ...
                                    <div class="main-box-body clearfix">
                                        <form class="form-horizontal" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" id="BranchName" name="BranchName" value="<?php //$row->BranchName ?>" placeholder="Branch Name">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="BranchAdd" class="col-lg-2 control-label">Branch Address</label>
                                                <div class="col-lg-10">
                                                    <input type="text" class="form-control" id="BranchAdd" name="BranchAdd" value="<?php //$row->BranchAddress ?>" placeholder="Branch Address">
                                                </div>
                                            </div>
                                            <?php //} ?>
                                            <div class="form-group">
