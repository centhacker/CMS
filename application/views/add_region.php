                    ...
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    <li><a href="#">Home</a></li>
                                    <li class="active"><span>Add Region</span></li>
                                </ol>
                                <h1>Add Region</h1>
                            </div>
                        </div>
                                ...
                                <div class="main-box">
                                    ...
                                    <div class="main-box-body clearfix">
                                        <form class="form-horizontal" role="form">
                                            <div class="form-group">
                                                <label for="Region" class="col-lg-2 control-label">Region Name</label>
                                                <div class="col-lg-10">
                                                    <input class="form-control" name="Region" id="Region" type="text" placeholder="Region">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-lg-offset-2 col-lg-10">
                                                    <input type="button" name="AddRegion" id="AddRegion" class="btn btn-success" value="Add">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
